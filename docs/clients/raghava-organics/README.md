# Raghava Organics — Client deployment docs
...
5. Nginx + Certbot (manual, per pack)
6. `OPS_EMAIL=... SETUP_BASE_URL=... bash .../phase8-ops-bootstrap.sh`
7. Copy [frontend/.env.production.example](../../../frontend/.env.production.example) → `.env.production.local` on VPS
8. `bash docs/clients/raghava-organics/scripts/phase10-frontend-deploy.sh`
